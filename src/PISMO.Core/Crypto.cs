...
namespace PISMO
{
    ...
    ///
    /// КЛЮЧ И ФОРМАТЫ ОБЩИЕ С WINDOWS И ANDROID — файл перенесён из
    /// PISMO_MESSENDGER/PISMO/Crypto.cs дословно. Менять его в одиночку
    /// нельзя: разойдётся ключ — Linux перестанет читать переписку,
    /// написанную с телефона и с ПК, и наоборот.
    ///
